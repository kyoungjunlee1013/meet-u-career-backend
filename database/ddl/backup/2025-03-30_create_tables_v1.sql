...
CREATE TABLE company (
    ...
    foundedDate DATE NOT NULL,  -- 설립일
    numEmployees INT NOT NULL,  -- 직원 수
    revenue BIGINT NOT NULL,  -- 매출액
    website VARCHAR(500) NOT NULL,  -- 회사 웹사이트 URL
    logoUrl VARCHAR(500) NULL,  -- 기업 로고 이미지 URL (NULL 가능)
    address VARCHAR(500) NOT NULL,  -- 회사 주소
...
CREATE TABLE resume (
    ...
    status INT NOT NULL DEFAULT 0,  -- 이력서 상태 (0: 활성, 1: 임시저장, 2: 삭제)
