...
import com.highfive.meetu.domain.calendar.common.type.CalendarEventTypes.EventType;
...
public class CalendarEvent extends BaseEntity {
    ...
    private EventType eventType;  // 일정 유형 (1:면접, 2:지원마감, 3:북마크마감, 4:기업이벤트, 5:개인일정) - 컨버터 자동 적용
